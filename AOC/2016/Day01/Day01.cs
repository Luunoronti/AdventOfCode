...
class Day01
{
    ...
    public string Part1(PartInput Input)
    {
        ...
        Visualizer.Run(new VizConfig { AutoPlay = true, CenterAtZero = true, AutoStepPerSecond = 40 }, () => Process(false), Draw, Tooltip, Status);
    ...
    public string Part2(PartInput Input)
    {
        ...
        Visualizer.Run(new VizConfig { AutoPlay = true, CenterAtZero = true, AutoStepPerSecond = 40 }, () => Process(true), Draw, Tooltip, Status);
