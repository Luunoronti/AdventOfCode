...
class Day12
{
    ...
    public static long Part1(string input) => (JsonConvert.DeserializeObject(input) as JArray)?.Sum(o => GetAllNumbers(o, ignoreRed: false)) ?? 0;
    public static long Part2(string input) => (JsonConvert.DeserializeObject(input) as JArray)?.Sum(o => GetAllNumbers(o, ignoreRed: true)) ?? 0;
