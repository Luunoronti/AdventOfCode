        ...
        if( hover )
        {
            ...
            if( ImGui::IsMouseHoveringRect( wpos + ImVec2( x0, 0 ), wpos + ImVec2( x1, ty ) ) )
            {
                ...
                if( fi )
                {
                    ...
                    if( fi->flip )
                    {
                        ImGui::Image( m_frameTexture, ImVec2( fi->w * scale* frameImageScale, fi->h * scale* frameImageScale ), ImVec2( 0, 1 ), ImVec2( 1, 0 ) );
                    }
                    else
                    {
                        ImGui::Image( m_frameTexture, ImVec2( fi->w * scale* frameImageScale, fi->h * scale* frameImageScale ) );
                    }
